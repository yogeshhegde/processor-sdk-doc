...
==============================================
.. include:: Target/Run_IPC_Examples_on_AM572x.rst.inc

Run IPC Examples on AM65XX
==============================================
.. include:: Target/Run_IPC_Examples_on_AM65xx.rst.inc

Taking the C66x Out Of Reset with Linux Running on the ARM A15
===============================================================
.. include:: Target/C66x_Reset_from_A15_Running_Linux.rst.inc
...
.. include:: Host/Setup/Setup_CCS_for_EVM_and_PSDK_RTOS.rst.inc


.. Update environment when installing to a custom path
.. -----------------------------------------------------
.. _Processor-SDK-RTOS-Install-In-Custom-Path-label:
.. include:: Host/Setup/Update_ENV_for_a_Custom_Path.rst.inc
...
-----------------------------------------------
.. include:: Host/Flashing_and_Boot/Flash_bootable_images.rst.inc
...
-------------------------------------------------------------------
.. include:: Host/Porting/Adding_Custom_Board_Library_Target_to_PSDK_RTOS_makefiles.rst.inc


Processor SDK RTOS Porting Guide for AM571x/AM570x Speed Grades
----------------------------------------------------------------
.. include:: Host/Porting/PSDK_RTOS_Porting_Guide_for_AM57xx_Speed_Grades.rst.inc
...
------------------------------------------------------------------------------------------------
.. include:: Host/System_Integration/Create_DSP_and_IPU_FW_using_PDK_and_IPC_to_load_from_ARM_AM57xx.rst.inc
...
--------------------------------------------
.. include:: Host/System_Integration/IPC_Debugging_Tools_and_Techniques_on_AM57xx.rst.inc
...
AM65x EVM 
===================
.. include:: EVM_Hardware_Setup/TMDX654_EVM_Hardware_Setup.rst.inc   
