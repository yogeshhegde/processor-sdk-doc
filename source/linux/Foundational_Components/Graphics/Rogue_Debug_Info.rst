...
#. Use rgx_triangle_test to verify that the GPU is able to render to an output
   buffer.
...
.. note:: When raising a ticket on e2e forums it is useful to include the
   output of this command if available.
