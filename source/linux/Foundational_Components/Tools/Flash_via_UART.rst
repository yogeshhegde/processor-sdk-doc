...
.. http://processors.wiki.ti.com/index.php/Flash_via_UART
...
uart_uniflash.py is located at

::

    <TI_SDK_PATH>/bin/uart_uniflash/uart_uniflash.py
...
.. ifconfig:: CONFIG_part_variant in ('AM62X','AM64X','AM62PX')
    ...
    **Flash configuration file for flashing to OSPI NOR**
    ...
    Create a flash configuration file. Refer to example_sbl_ospi_linux.cfg for GP
    devices, example_sbl_ospi_linux_hs.cfg for HS and example_sbl_ospi_linux_hs_fs.cfg
    for HS-FS.
...
.. ifconfig:: CONFIG_part_variant in ('AM62AX')
    ...
    **Flash configuration file for flashing to OSPI NAND**
    ...
    Create a flash configuration file. Refer to example_sbl_ospi_nand_linux.cfg
    for GP devices, example_sbl_ospi_nand_linux_hs.cfg for HS and example_sbl_ospi_nand_linux_hs_fs.cfg
    for HS-FS.
