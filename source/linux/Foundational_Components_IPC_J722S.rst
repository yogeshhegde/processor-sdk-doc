...
.. code-block:: console
	...
	lrwxrwxrwx  1 root root      72 Dec  7 15:36 j722s-main-r5f0_0-fw -> /lib/firmware/ti-ipc/j722s/ipc_echo_test_main-r5f0_0_release_strip.xer5f
        lrwxrwxrwx  1 root root      67 Dec  7 15:37 j722s-mcu-r5f0_0-fw -> /lib/firmware/ti-ipc/j722s/ipc_echo_test_mcu0_0_release_strip.xer5f
        lrwxrwxrwx  1 root root      65 Dec  7 15:39 j722s-c71_0-fw -> /lib/firmware/ti-ipc/j722s/ipc_echo_test_c7x_0_release_strip.xe71
        lrwxrwxrwx  1 root root      65 Dec  7 15:40 j722s-c71_1-fw -> /lib/firmware/ti-ipc/j722s/ipc_echo_test_c7x_1_release_strip.xe71
...
.. code-block:: console
	...
	[  748.578297] remoteproc remoteproc3: stopped remote processor 78400000.r5f

If needed, update the firmware symbolic link to point to a new firmware:

.. code-block:: console

	root@j722s-evm:/lib/firmware# ln -sf /lib/firmware/ti-ipc/j722s/ipc_echo_test_main-r5f0_0_release_strip.xer5f j722s-main-r5f0_0-fw

Finally, use the sysfs interface to start the remote core:

.. code-block:: console

	root@J722S-evm:~# echo start > /sys/class/remoteproc/remoteproc5/state
	[  798.485687] remoteproc 78400000
	[  798.491423] remoteproc remoteproc4: Booting fw image j722s-main-r5f0_0-fw, size 45492
	[  798.500410] rproc-virtio rproc-virtio.5.auto: assigned reserved memory node main-r5fss-dma-memory-region@a2000000
